...
class ParametrosQueries
{
    ...
    */
    ...
    {
        $sql = 'SELECT idparametro, nombreemp, direccionemp, porcentaje, registro, giroempresa, nit, dui, correocontac
    ...
    {
        $sql = 'INSERT INTO parametros(nombreemp, direccionemp, porcentaje, registro, giroempresa, nit, dui, idcontacto)
                VALUES(?,?,?,?,?,?,?,?)';
    ...
    {
        $sql = 'SELECT idparametro, nombreemp, direccionemp, porcentaje, registro, giroempresa, nit, dui, idcontacto
                FROM parametros
                WHERE idparametro = ?';
    ...
    public function actualizarRegistro()
    {
        $sql = 'UPDATE parametros
                SET nombreemp = ?, direccionemp = ?, porcentaje = ?, registro = ?, giroempresa = ?, nit = ?, dui = ?, idcontacto = ?
                WHERE idparametro = ?';
