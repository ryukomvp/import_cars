        ...
        if (JSON.status) {
            ...
            <div id="drawer-navigation"
                ...
                <div class="py-4 overflow-y-auto">
                    <ul class="space-y-2 font-medium">
                        ...
                        <!-- data-collapse-toggle="dropdown-inventory" es el identificador correcto dentro de flowbite para poder desplegar los dropdown, en resumen es el identificador que luego se busca abajo como id-->
                        <li>
                            <button type="button"
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap">Facturación</span>
                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="m1 1 4 4 4-4" />
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap">Misceláneos</span>
                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="m1 1 4 4 4-4" />
                        ...
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Procesos</span>
                            </a>
                        </li>
                        <li>
            ...
            <nav class="bg-azul border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xxl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <span class="text-4xl font-semibold text-white dark:text-white">Import Cars</span>
